...
import { Combine, Plus, Split, Star, Trash2, Undo2 } from "lucide-react";
...
type PropertyFilter = { key: string; op: "eq" | "neq" | "contains" | "exists" | "not_in"; value?: string; values?: string[] };
